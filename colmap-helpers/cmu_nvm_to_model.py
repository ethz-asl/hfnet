...
def export_image_data(image_data, image_id_to_keypoints, slice_number):
    ...
    for nvm_data in tqdm(image_data, total=len(image_data), unit="images"):
        ...
        camera_id, width, height, params = camera_params_from_image_id(db_image_id, args.slice)
        ...
        keypoints = read_keypoints_from_db(db_image_id, args.slice)
