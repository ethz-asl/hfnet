...
python3 colmap-helpers/update_db_with_nvm_intrinsics.py --database_file aachen.db --nvm_file aachen_cvpr2018_db.nvm

# Use the provided NVM file for ground-truth poses of all the cameras.
mkdir initial_model_sift
python3 colmap-helpers/colmap_model_from_nvm.py --database_file aachen.db --nvm_file aachen_cvpr2018_db.nvm --output_dir initial_model_sift/
